...
function PageTableauBord() {
    ...
    return (
        <div>
            {(stateAllUtilisateur?.role?.id === 4 || stateAllUtilisateur?.role?.id === 1) && <TbResponsableStock />}
            {(stateAllUtilisateur?.role?.id === 3 || stateAllUtilisateur?.role?.id === 1) && <TbMagasinier />}
            {(stateAllUtilisateur?.role?.id === 2 || stateAllUtilisateur?.role?.id === 1)&& <TbCaissier />}
