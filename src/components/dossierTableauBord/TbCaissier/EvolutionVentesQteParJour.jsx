...
function EvolutionVentesQteParJour() {
  ...
  const maxValue = Math.max(
    ...(stateEvolutionVenduParJoursCaissier?.map((d) => d.qte_vendu) || [0])
  );
  ...
  return (
    <div className="card shadow-sm" ref={containerRef}>
      <div className="card-header bg-secondary text-white">
        📊 Tendance des quantités Vendue par Jours
      </div>
        ...
        <ResponsiveContainer width="100%" height={chartHeight}>
          <LineChart data={stateEvolutionVenduParJoursCaissier}>
            ...
            <Line
              ...
              activeDot={{ r: 6 }}
            >
              <LabelList dataKey="qte_vendu" content={<CustomLabel />} />
            </Line>
          </LineChart>
        </ResponsiveContainer>
      </div>
...
export default EvolutionVentesQteParJour;
