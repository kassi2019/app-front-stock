...
export const useLogiqueProduit = () => {
  ...
  //   setinfoLotProduit(row.id);
  //   console.log({stateInformationSurLotParProduit});
  //   setModalState2({
  //     show: true,
  //     title: "Information sur le lot de produit",
  //     content: (
  ...
  //               <td>{row.code}</td>
  //               <td>{row.libelle}</td>
  //               <td style={{ textAlign: "right" }}>azerty</td>
  ...
  //           <tbody>
  //             {stateInformationSurLotParProduit.map(
  //               (row7, index) => (
  //                 console.log({ row7 }),
  //                 (
  //                   <tr key={index}>
  //                     <td>{row.code_lot}</td>
  //                     {/* <td>{row.quantite_inital}</td>
